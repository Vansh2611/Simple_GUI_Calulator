...
btn_9= tk.Button(root, text="0", command=lambda: add_to_calculations(0), width=5, font = ("Arial", 14))
btn_9.grid(row=5,column=2)
btn_10= tk.Button(root, text="C", command=clear_field, width=11, font = ("Arial", 14))
btn_10.grid(rowspan =2,column=3, columnspan=2)
...
btn_mult= tk.Button(root, text="*", command=lambda: add_to_calculations('*'), width=5, font = ("Arial", 14))
